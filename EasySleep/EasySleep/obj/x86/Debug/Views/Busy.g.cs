#pragma checksum "C:\Users\ma4tt\Desktop\EDV\EasySleep\EasySleep\Views\Busy.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "498C3F16BFA79515DD322F4CDA198A5B"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace EasySleep.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class Busy_obj1_Bindings :
            ...
            IBusy_Bindings
        {
            private global::EasySleep.Views.Busy dataRoot;
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::EasySleep.Views.Busy)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::EasySleep.Views.Busy obj, int phase)
            {
            ...
            private class Busy_obj1_BindingsTracking
            {
                ...
                public void DependencyPropertyChanged_IsBusy(global::Windows.UI.Xaml.DependencyObject sender, global::Windows.UI.Xaml.DependencyProperty prop)
                {
                    ...
                    {
                        global::EasySleep.Views.Busy obj = sender as global::EasySleep.Views.Busy;
                        if (obj != null)
                        {
                ...
                public void UpdateChildListeners_(global::EasySleep.Views.Busy obj)
                {
                    Busy_obj1_Bindings bindings;
                    if (WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        {
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::EasySleep.Views.Busy.IsBusyProperty, tokenDPC_IsBusy);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::EasySleep.Views.Busy.BusyTextProperty, tokenDPC_BusyText);
                        }
                        if (obj != null)
                        {
                            bindings.dataRoot = obj;
                            tokenDPC_IsBusy = obj.RegisterPropertyChangedCallback(global::EasySleep.Views.Busy.IsBusyProperty, DependencyPropertyChanged_IsBusy);
                            tokenDPC_BusyText = obj.RegisterPropertyChangedCallback(global::EasySleep.Views.Busy.BusyTextProperty, DependencyPropertyChanged_BusyText);
                        }
                    }
                }
            }
